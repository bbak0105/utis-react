...
import s from './FindId.module.scss'
...
const FindId = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    // TODO: 실제 아이디 찾기 로직 연동
    console.log('findId', { memberType, method, name, email, phone })
    alert('임시 안내: 아이디 찾기 요청이 전송되었습니다.')
  }
  ...
  return (
    <div className={s.container}>
      ...
      <h1 className={s.title}>아이디 찾기</h1>
